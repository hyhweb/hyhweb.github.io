$(function () {
    ...
    var renderFormData = {
        ...
        data:[
            ...
            },
            {
                ...
                onClick:function () {
                    ...
                    var result =  $('#datagrid-form').form("getFormData");
        ...
        complete:function () {
            dataGridOption.queryParams = $('#datagrid-form').form("getFormData");
            $('#datagrid').datagrid(dataGridOption);
        }
    };
    var dataGridOption = {
        title:'数据表格',
    ...
    $('#datagrid-form').form(renderFormData);
    $('#datagrid-form').form("load",selectedData);
