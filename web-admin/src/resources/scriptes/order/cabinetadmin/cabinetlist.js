$(function () {
    ...
    var renderFormData = {
        ...
        data:[
            ...
            },*/
            {
                ...
                onClick:function () {
                    ...
                    var result =  $('#cabinet-form').form("getFormData");
                    $.messager.alert('提示',JSON.stringify(result));
                    $('#cabinet-list').datagrid({
                        queryParams: result
                    });
        ...
        complete:function () {
            dataGridOption.queryParams = $('#cabinet-form').form("getFormData");
            $('#cabinet-list').datagrid(dataGridOption);
        }
    };
        ...
        toolbar: [
            {
                ...
                handler:function(){
                    ...
                    var dialogBox =  $('#cabinet-dialog').dialog({
                        title: '添加',
                        width: 650,
                        height: 500,

                        modal:true,
                        href:"pages/demo/datagrid.html",
                        toolbar:[{
                            text:'编辑',
                            iconCls:'icon-edit',
                            handler:function(){
    ...
    $('#cabinet-form').form(renderFormData);
    $('#cabinet-form').form("load",selectedData);
