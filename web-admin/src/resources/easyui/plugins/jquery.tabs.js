...
//		$('div.tabs-container', container).tabs();
	...
	function exists(container, title){
        var exist = false;
	     $('div.tabs-header li span.tabs-closable',container).each(function (key,item) {
	        if($(item).html()==title){
                exist = true;
            }
        })
	...
	$.fn.tabs = function(options, param){
		if (typeof options == 'string') {
			switch(options) {
                ...
                case 'getTab':
                    return getTab(this, param);
                case 'getTabIndex':
                    return this.each(function() {
                        return getTabIndex(this, param);
                    })
                case 'getSelected':
                    return this.each(function(){
                        return  getSelectedTab(this, param);
					})
