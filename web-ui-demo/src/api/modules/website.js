...
export const allFleetListApi = params => {return instance.post(`/ygb-system-service/api/system/sysOrg/getDeptItemByLevel?level=3`,params)}
...
export  const  batchUploadPicApi = params =>{return instance.post(`${moduleName}/api/dispatch/schedule/batchUploadPics`,params)}
