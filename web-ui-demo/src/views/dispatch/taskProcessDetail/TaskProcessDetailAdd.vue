<template>
  <el-dialog title="新增任务流流程详情" :visible.sync="taskModel">
...
<script>
  ...
  import{saveTaskProcessDetail,getTaskProcessNameList,getTaskNodeNameList} from '../../../api/modules/dispatch'
  export default {
    data() {
      return {
        taskModel: false,
    ...
    methods: {
      ...
      onSubmit() {
        this.$refs.form.validate((valid) => {
            if(valid){
              saveTaskProcessDetail(this.form)
                .then((res) => {
