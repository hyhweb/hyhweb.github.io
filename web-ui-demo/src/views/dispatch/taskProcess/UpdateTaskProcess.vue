<template>
  <el-dialog title="修改任务流程" :visible.sync="taskModel">
...
<script>
  ...
  import{saveTaskProcess,updateTaskProcess} from '../../../api/modules/dispatch'
  export default {
    data() {
      return {
        update:{},
    ...
    watch: {
      update(val){
        ...
        this.form.orderType = this.form.orderType.toString()
      }
    },
  };
</script>
