    ...
    <section class="ke_hu_bao_jia">
        ...
        <el-form :inline="true" ref="form" :model="form" label-width="100px">
          ...
          <el-form-item label="港口" prop="harborId">
            <el-select filterable
                       v-model="form.harborId" placeholder="请选择港口" class='control-width'>
              <el-option value="">请选择</el-option>
          ...
          <el-form-item label="客户名称" prop="customerId">
            <el-select filterable v-model="form.customerId" placeholder="请选择用户">
              <el-option value="">请选择</el-option>
          ...
          <el-form-item label="船公司" prop="shipCompanyId">
            ...
            <el-select filterable v-model="form.shipCompanyId" placeholder="请选择船公司">
              <el-option value="">请选择</el-option>
          ...
          <el-form-item label="操作人" prop="operUserId">
            <el-select filterable v-model="form.operUserId" placeholder="请选择操作人" class='control-width'>
              <el-option value="">请选择</el-option>
          ...
          <el-form-item label="失效日期" prop="updateDate">
            <el-date-picker type="date" placeholder="失效日期" v-model="form.validityEndDateStart"
                            style="width:140px"></el-date-picker>
            至
            <el-date-picker type="date" placeholder="失效日期" v-model="form.validityEndDateEnd"
                            style="width:140px"></el-date-picker>
          </el-form-item>
      ...
      <el-table ref="table"
        ...
        <el-table-column class-name="cell-group"
          ...
          <template scope="scope">
            <div class="content-rowspan">
              <div>{{getShipmentDate(scope.row.cqdlList,0,0)}}</div>
              <div>{{getShipmentDate(scope.row.cqdlList,0,1)}}</div>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column class-name="cell-group"
          ...
          <template scope="scope">
            <div class="content-rowspan">
              <div>{{getShipmentDate(scope.row.cqdlList,4,0)}}</div>
              <div>{{getShipmentDate(scope.row.cqdlList,4,1)}}</div>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column class-name="cell-group"
          ...
          <template scope="scope">
            <div class="content-rowspan">
              <div>{{getShipmentDate(scope.row.cqdlList,2,0)}}</div>
              <div>{{getShipmentDate(scope.row.cqdlList,2,1)}}</div>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column class-name="cell-group"
          ...
          <template scope="scope">
            <div class="content-rowspan">
              <div>{{getShipmentDate(scope.row.cqdlList,3,0)}}</div>
              <div>{{getShipmentDate(scope.row.cqdlList,3,1)}}</div>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column class-name="cell-group"
          ...
          <template scope="scope">
            <div class="content-rowspan">
              <div>{{getShipmentDate(scope.row.cqdlList,1,0)}}</div>
              <div>{{getShipmentDate(scope.row.cqdlList,1,1)}}</div>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column class-name="cell-group"
          ...
          <template scope="scope">
            <div class="content-rowspan">
              <div>{{getShipmentDate(scope.row.cqdlList,5,0)}}</div>
              <div>{{getShipmentDate(scope.row.cqdlList,5,1)}}</div>
            </div>
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //装货对应的报价信息
      getShipmentDate(cqdlList,cabinetType,transportType){
        if(cqdlList){
         let item = cqdlList.filter((res)=>{
      ...
      getList(){
        ...
        this.pageHandler(this.form, this.getCustomerLog);
      },
    ...
    watch: {
      detail(val){
        if(val){
          this.form.customerQuoteId = val.id;
        } else {
          this.form.customerQuoteId = ''
        }
        this.getList();
      }
    },
