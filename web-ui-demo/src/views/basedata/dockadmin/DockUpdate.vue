...
<el-dialog
    title="编辑码头信息"
    v-model="newDockdialogVisible" class="dock_updata_windown">
  <el-form ref="form" :rules="addFormRules" :model="form"  label-width="80px" >
  <el-form-item label="码头名称"  prop="name" class="dockupdata_list_width">
    <el-input v-model="form.name"></el-input>
  </el-form-item>

  <el-form-item label="码头公司"  prop="thirdPartCompany" class="dockupdata_list_width">
    <el-input v-model="form.thirdPartCompany"></el-input>
  </el-form-item>
    <el-form-item  label="所属港口" prop="harborId" class="dockupdata_list_width">
  ...
  <el-form-item label="码头类型" prop="dockType" class="dockupdata_list_width">
  ...
  <el-form-item label="经度" prop="longitude" class="dockupdata_list_width">
    <el-input v-model="form.longitude"></el-input>
  </el-form-item>
  <el-form-item label="纬度" prop="latitude" class="dockupdata_list_width">
    <el-input v-model="form.latitude"></el-input>
  </el-form-item>
  </el-form-item>
    <el-form-item label="地区"  prop="regionName" class="dockupdata_list_width dockupdata_list2_width">
    <el-select
  ...
  <el-form-item label="地址" prop="address" class="dockupdata_list_width dockupdata_list2_width dockupdata_list4_width">
    <el-input v-model="form.address"></el-input>
  </el-form-item>
  <el-form-item label="联系人" prop="contacts" class="dockupdata_list_width">
    <el-input v-model="form.contacts"></el-input>
  </el-form-item>
   <el-form-item label="联系方式" prop="phone" class="dockupdata_list_width">
    <el-input v-model="form.phone"></el-input>
  </el-form-item>
  <el-form-item label="是否电子入闸" prop="isElecgate" class="dockupdata_list_width dockupdata_list3_width">
   <el-select v-model="form.isElecgate" placeholder="是否电子入闸">
     <el-option label="是" value="1"></el-option>
     <el-option label="否" value="0"></el-option>
   </el-select>
     </el-form-item>
   <el-form-item label="第三方码头系统代码" prop="thirdPartCode" class="dockupdata_list_width dockupdata_list3_width">
    <el-input v-model="form.thirdPartCode"></el-input>
  </el-form-item>
  </el-form-item>
  <el-form-item label="是否禁用" prop="isUnable" class="dockupdata_list_width">
   <el-select v-model="form.isUnable" placeholder="请选择是否禁用">
     <el-option label="是" value="1"></el-option>
     <el-option label="否" value="0"></el-option>
   </el-select>
     </el-form-item>
  <el-form-item class="dockupdata_list_width dockupdata_list2_width">
...
<style>
  .dock_updata_windown .el-dialog{
    /*border: 3px solid red;*/
    min-width:664px;
    border-radius: 6px;
    padding-right: 14px;
  }
  .dock_updata_windown  .el-dialog .el-dialog__body .dockupdata_list_width{
    width:48%;
  ...
  .dock_updata_windown .dockupdata_list_width .el-select{
    width:100%;
  }
  .dock_updata_windown .el-dialog .el-dialog__body .dockupdata_list2_width{
    width: 100%;
  }
  .dock_updata_windown .el-dialog .el-dialog__body .dockupdata_list2_width>.el-form-item__content .el-select{
    width: 31%;
    padding-right: 6px;
  }
  .dock_updata_windown .el-dialog .el-dialog__body  .dockupdata_list2_width>.el-form-item__content .el-select:last-of-type{
    padding-right:0px;
  }
  .dock_updata_windown  .el-dialog .el-dialog__body .el-form .dockupdata_list_width:last-of-type .el-form-item__content{
    width: 22%;
    margin: 0 auto!important;
  }
  .dock_updata_windown .el-dialog .el-dialog__body .el-form .dockupdata_list3_width .el-form-item__label{
    padding:0px 12px 0 0!important;
  }
  .dock_updata_windown .el-dialog .el-dialog__body .el-form .dockupdata_list3_width{
    padding-bottom: 15px;
  }
  .dock_updata_windown .el-dialog .el-dialog__body .dockupdata_list4_width .el-input{
    width: 96.5%;
  }
...
<script>
  ...
  label: {},
    ...
    methods: {
      ...mapActions([
        'getDockList','updateDock','HarborBelongList','RegionBelongPList','RegionBelongCList','getRegionCode','getRegions'
        ]),
      test(){
            ...
            this.$refs.form.validate((valid) => {
                if(valid){
                    ...
                    getRegionCodeParam.then((res)=>{
                        ...
                        this.updateDock(this.form).then(res =>{
                            if(res.success){
                                this.$refs.form.resetFields()
                                this.newDockdialogVisible = false;
                                this.form.selectedRegion="",
    ...
    watch:{
      detail(val){
       ...
       if(this.form.isElecgate){
         this.form.isElecgate = "1"
       }else{
          this.form.isElecgate = "0"
       }
          if(this.form.dockType==1){
              this.form.dockType = "1"
          }else{
              this.form.dockType = "2"
          }
      }
