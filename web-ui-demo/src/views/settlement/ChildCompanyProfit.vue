<template>
  ...
  <section>
        ...
        <el-form class="query-modal" :inline="true" :model="form" ref="form" @submit.prevent="onSubmit">
          <div class="query-params">
            <el-form-item label="子公司名称" :label-width="labelWidth" prop="childCompany">
              <el-input v-model="form.childCompany" class='control-width'></el-input>
            </el-form-item>
            ...
            <!--<br>-->
	            ...
	            <el-form-item label="结算日期" :label-width="labelWidth" prop="settlementDateStart" style="margin-right:2px">
	              <el-date-picker type="date" placeholder="选择日期" v-model="form.settlementDateStart"
	                              style="width:120px" @change="settlementDateStartChange"></el-date-picker>
	            </el-form-item>
	            <label style="padding-right:0;padding-top:11px;">-</label>
	            <el-form-item label="" :label-width="labelWidth" prop="settlementDateEnd">
	              <el-date-picker type="date" placeholder="选择日期" v-model="form.settlementDateEnd"
	                              style="width:120px" @change="settlementDateEndChange"></el-date-picker>
	            </el-form-item>
	          </div>

						<div style="display: inline-block; vertical-align: top;">
	            <el-form-item class="long-label" label="行程结束日期" :label-width="labelWidth" prop="endDateStart" style="margin-right:2px;">
	              <el-date-picker type="date" placeholder="选择日期" v-model="form.endDateStart" style="width:120px"
	                              @change="endDateStartChange"></el-date-picker>
	            </el-form-item>
	            <label style="padding-right:0;padding-top:11px;">-</label>
	            <el-form-item label="" :label-width="labelWidth" prop="endDateEnd">
	              <el-date-picker type="date" placeholder="选择日期" v-model="form.endDateEnd" style="width:120px"
    ...
    <el-col :span="24" class="toolbar">
      <el-button :disabled="this.$global.isDisabled(21)" type="primary" size="small" @click="exportChildCompanyProfit">导出excel
      </el-button>
    ...
    <!--列表-->
    <el-col>
      <el-table ref="table" :maxHeight="tableMaxHeight" @row-click="handleRowClick" highlight-current-row :data="childCompanyProfitList.data" stripe
                @selection-change="handleSelectionChange" border>
        <el-table-column type="selection" v-model="selectData" fixed width="40">
        </el-table-column>
        <el-table-column prop="childCompany" label="子公司" min-width="150" align="center">
        </el-table-column>
...
<script>
  ...
  import {getChildCompanyProfitExcelApi} from '../../api/modules/settlement'
  import Qs from 'qs';
    ...
    data() {
      return {
        ...
        form: {
          ...
          childCompany: '',//子公司
          Authorization: '',//token
          settlementDateStart:'',//结算开始时间
          settlementDateEnd:''//结算结束时间
        },
      };
    },
    computed: {
      ...mapGetters([
        'childCompanyProfitList', 'orderStatus','childCompanyProfitAmount'
      ]),
    },
    methods: {
      ...mapActions([
        'getChildCompanyProfitList', 'getOrderStatus','getChildCompanyProfitAmount'
      ]),
      init() {
      ...
      exportChildCompanyProfit(){
        this.$confirm('确认要导出子公司利润信息吗?', '提示', {
          ...
          this.download({
            params: params,
            handle: getChildCompanyProfitExcelApi,
            callback () {
      ...
      getDataList(initpage) {
        ...
        let success = success =>{
          if(this.childCompanyProfitAmount.incomeAmount != null){
            this.incomeAmount = this.childCompanyProfitAmount.incomeAmount;
          }
          if(this.childCompanyProfitAmount.payAmount != null){
            this.payAmount = this.childCompanyProfitAmount.payAmount;
          }
          if(this.childCompanyProfitAmount.profit != null){
            this.profitAmount = this.childCompanyProfitAmount.profit;
          }
        };
        //子公司
        ...
        this.pageHandler(this.form, this.getChildCompanyProfitList,initpage,success);
        this.getChildCompanyProfitAmount(this.form);
      },
      // 查询
      onSubmit() {
