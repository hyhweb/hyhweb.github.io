  ...
  <el-dialog
    ...
    <el-form ref="form" :model="form" label-width="100px">
      <el-form-item label="申请单编号" prop="requisitionId" :label-width="labelWidth">
        <el-input v-model="form.requisitionId" :disabled="true" class='control-width2'></el-input>
      </el-form-item>
      <!--办单员以外场合显示-->
      ...
      <el-form-item label="付款对象" prop="payObjBDY" v-show="form.showFlgB" :label-width="labelWidth">
        <el-input v-model="form.payObjBDY" :disabled="true" class='control-width2'></el-input>
      </el-form-item>
      ...
      <el-form-item label="付款方式(隐藏)" prop="payType" v-show="false" :label-width="labelWidth">
        <el-input v-model="form.payType" :disabled="true" class='control-width2'></el-input>
      </el-form-item>
      <el-form-item label="付款方式" prop="payTypeName" v-show="form.showFlgA" :label-width="labelWidth">
        <el-input v-model="form.payTypeName" :disabled="true" class='control-width2'></el-input>
      </el-form-item>
      <el-form-item label="申请单金额" prop="reqAmount" :label-width="labelWidth">
        <el-input v-model="form.reqAmount" :disabled="true" class='control-width2'></el-input>
      </el-form-item>
      <el-form-item label="付款金额" prop="unpaidAmount" :label-width="labelWidth">
        <el-input v-model="form.unpaidAmount" :disabled="true" class='control-width2'></el-input>
      </el-form-item>
...
<script>
  ...
  import {payRequisitionApi} from '../../../api/modules/settlement'
  ...
  export default {
    ...
    methods: {
      ...mapActions([
        'getRequisitionList', 'payRequisition'
      ]),
      getList(){
      ...
      onSubmit() {
        payRequisitionApi(this.form).then((res) => {
          let data = res.data;
          if (data.code == 1) {
