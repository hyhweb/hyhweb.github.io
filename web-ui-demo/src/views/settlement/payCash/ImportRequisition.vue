<template>
  <el-dialog
    ...
    <el-table
      ref="table" @row-click="handleRowClick" :data="payCashImportPageList.data" @selection-change="handleSelectionChange" stripe>
...
<script>
  ...
  import {importPayCashApi} from '../../../api/modules/settlement'
...
//箱号
        ...
        this.pageHandler(this.form, this.getPayCashImportPageList)
      },
      onSubmit() {
        this.getList()
      },
...
//引入对象集合
          ...
          importPayCashApi({data: JSON.stringify(this.saveImportForm)}).then((res) => {
            if (res.data) {
            this.getList()
            this.$parent.getList()
...
// this.form.payObjIdBak = this.form.payObjId;
// if(this.form.payObjectType==1){
// this.form.showFlgA=true;
// }else{
// this.form.showFlgA=false;
