...
<!--        <el-table-column prop="evaluateType" label="评价类型" width="180" sortable>
        ...
        <el-table-column label="总评价" width="90">
          <template scope="scope">
            <ul>
              <li v-for="n in scope.row.evaluateLevel" style="display:inline-block">
                <i style="color: black;" class="el-icon-star-on"></i>
              </li>
            </ul>
          </template>
        </el-table-column>
        <el-table-column label="装卸速度" width="90">
          <template scope="scope">
            <ul>
              <li v-for="n in scope.row.stevedoringSpeedLevel" style="display:inline-block">
                <i style="color: black;" class="el-icon-star-on"></i>
              </li>
            </ul>
          </template>
        ...
        <el-table-column label="路面情况" width="90">
          <template scope="scope">
            <ul>
              <li v-for="n in scope.row.pavementLevel" style="display:inline-block">
                <i style="color: black;" class="el-icon-star-on"></i>
              </li>
            </ul>
          </template>
        ...
        <el-table-column label="管理规范" width="90">
          <template scope="scope">
            <ul>
              <li v-for="n in scope.row.manageLevel" style="display:inline-block">
                <i style="color: black;" class="el-icon-star-on"></i>
              </li>
            </ul>
          </template>
        ...
        <el-table-column label="签收正规" width="90">
          <template scope="scope">
            <ul>
              <li v-for="n in scope.row.receiptFormLevel" style="display:inline-block">
                <i style="color: black;" class="el-icon-star-on"></i>
              </li>
            </ul>
          </template>
        ...
        <el-table-column label="业务规模" width="90">
          <template scope="scope">
            <ul>
              <li v-for="n in scope.row.businessScaleLevel" style="display:inline-block">
                <i style="color: black;" class="el-icon-star-on"></i>
              </li>
            </ul>
          </template>
