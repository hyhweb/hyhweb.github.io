...
(function ($)
{
    ...
    {
        return $.hongui.run.call(this, "combobox", arguments);
    };

    $.honguidefaults.combobox = {
        resize: true,           //是否调整大小
    ...
    //扩展方法
    $.honguimethods.combobox = $.honguimethods.combobox || {};


    $.hongui.controls.combobox = function (element, options)
    {
        $.hongui.controls.combobox.base.constructor.call(this, element, options);
    };
    $.hongui.controls.combobox.honguiextend($.hongui.controls.input, {
        __getType: function ()
        {
            return 'combobox';
        },
        ...
        {
            return $.honguimethods.combobox;
        },
        _init: function ()
        {
            $.hongui.controls.combobox.base._init.call(this);
            var p = this.options;
            if (p.columns)
            {
    ...
    $.hongui.controls.combobox.prototype.setValue = $.hongui.controls.combobox.prototype.selectValue;
    //设置文本框和隐藏控件的值
    $.hongui.controls.combobox.prototype.setInputValue = $.hongui.controls.combobox.prototype._changeValue;
